    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <!--     <li class="dropdown messages-menu">
		...
		if(null == lm)
			...
			RentService 			rn_s	=	new RentService();
			ArrayList<RentModel>	r_arr 	=	rn_s.SelectMyDue(lm.getUid());
			int not_count 					=	r_arr.size();
		%>
         <li class="dropdown notifications-menu">
            
            <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-bell-o"></i>
              <span class="label label-warning"><%= not_count %></span>
            </a>
            <ul class="dropdown-menu">
            <% if(not_count > 0){ %>
              <li class="header">You have <%= not_count %> notifications</li>
              <li>
                <ul class="menu">
                 <% for( RentModel rnm:r_arr){ %>
                  <li>
                    <a href="RentDue.jsp?rn_id=<%= rnm.getRent_id()%>">
                      <i class="fa fa-money text-aqua"></i>Room rent due on <b><%= rnm.getDue_date() %></b>
                    </a>
                  </li>
                 <% } %>
                </ul>
              </li>
              <li class="footer"><a href="RentDue.jsp">View all</a></li>
              <% }else{ %>
         ...
         <!--  Tasks Menu
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="Uploads/Company_Admin/<%=pic %>" class="user-image" alt="User Image">
